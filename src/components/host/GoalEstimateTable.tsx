...
export function GoalEstimateTable({
  ...
  return (
    <details className="group">
      <summary className="flex cursor-pointer items-center gap-1 text-xs font-medium text-muted-foreground marker:content-none [&::-webkit-details-marker]:hidden">
        <span className="underline-offset-2 group-open:underline">
          Estimate answers needed
        </span>
        <ChevronUp className="size-3.5 shrink-0 transition-transform duration-200 group-open:rotate-180" />
      </summary>
